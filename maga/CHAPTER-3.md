...
# Глава 3: Проектирование и реализация доверенной операционной системы
 ...
 ## 3.10. Фреймворк доверенных приложений
  ...
  ### Спецификация стандартной библиотеки для работы со строками

   #### Утилиты для работы со строками и памятью
  ...
  ### Спецификация стандартной криптографической библиотеки
   ...
   #### Шифрование, дешифрование, управление ключами и ГПСЧ
  ...
  ### Спецификация стандартной библиотеки контейнеров

   #### Функции для списков и деревьев
  ...
  ### Спецификация стандартной библиотеки для поддержки параллелизма
  ...
  ### Спецификация различных вспомогательных функций

   #### Макросы для выравнивания, побитовых операций и работы с компилятором
