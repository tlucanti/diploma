...
# Глава 3: Проектирование и реализация доверенной операционной системы
 ...
 ## 3.7. Дизайн и реализация ядра Secure OS
  ...
  загрузки исполняемых файлов Доверенных Приложений (ДП).
   ...
   #### Линейная файловая система в ОЗУ
 ...
 ## Capability-Based Модель Безопасности
  ...
  ### Мандатный и Дискреционный контроль доступа
   ...
   #### сочетание гранулярности DAC, строгости MAC и устранение их недостатков
  ...
  ### Дескрипторы как инкапсулированные мандаты
  ...
  - Контекстная специфичность: <br>
   ...
   ### Контроль доступа на основе полномочий
